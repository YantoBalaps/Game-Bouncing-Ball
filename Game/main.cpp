            ...
            while (true) {
                ...
                if (cirY <= 0) {
                    ...
                    if (cirX >= playerX && cirX <= playerX + 10) {
                        ...
                        // Clear the screen sebelum balik ke menu
                        system("CLS");
                ...
                if (cirX >= playerX and cirX <= playerX + 10 && cirY >= CIRBOUNDY - 2) {
                    hasCollided = false; // Reset sentuhan
                }
